...
import {
  LayoutDashboard, Users, BookOpen, Layers, Lightbulb,
...
function Sidebar() {
  ...
  const currentStudentId = user?.id || 15;
  ...
  return (
    <div className="w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 px-4 py-6 min-h-[calc(100vh-64px)] flex flex-col transition-colors">
      ...
      <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-800">
        ...
        {/* Demo Student Selector Dropdown Box — only visible when in Student mode */}
        {!isAdmin && (
          <div className="mt-3">
            ...
            <p className="text-[9px] text-gray-400 dark:text-gray-500 mt-1.5 px-0.5 leading-snug">
              Select any of the 4 students to view their profile, interview, &amp; room allocation.
            </p>
          </div>
        )}
      </div>
